    ...
    <section class="inner_page_wrapper section_padding area">
        ...
        <article class="container">
            <div class="plugins_content area">
                <h4><img src="<?php echo get_template_directory_uri() . '/assets/img/search_result_plugin_icon.svg' ?>" alt="plugins"><?php echo __( ' Plugins ', 'keck-observatory' ) ?></h4>
                <?php
                while ( have_posts() ) {
                    the_post();
            ...
            <div class="blog_posts_content area">
                <h4><img src="<?php echo get_template_directory_uri() . '/assets/img/search_result_blogpost_icon.svg' ?>" alt="blog posts"><?php echo __( ' Blog posts ', 'keck-observatory' ) ?></h4>
                <?php
                while ( have_posts() ) {
                    the_post();
            ...
            <div class="documentations_content area">
                <h4><img src="<?php echo get_template_directory_uri() . '/assets/img/search_result_documentations_icons.svg' ?>" alt="documentations"><?php echo __( ' Documentation ', 'keck-observatory' ) ?></h4>
                <?php
                while ( have_posts() ) {
                    the_post();
